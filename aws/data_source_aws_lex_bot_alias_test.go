...
func TestAccDataSourceAwsLexBotAlias(t *testing.T) {
	t.Skip("The Lex intent PR and Lex bot PR must be merged for this test to pass. https://github.com/terraform-providers/terraform-provider-aws/pull/8917 https://github.com/terraform-providers/terraform-provider-aws/pull/8918")
